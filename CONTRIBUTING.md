Contributing to Pluscoin Core
============================

The Pluscoin Core project operates an open contributor model where anyone is
...
The following applies to code changes to the Condominium Core project, and is not to be
confused with overall Condominium Network Protocol consensus changes.

Whether a pull request is merged into Condominium Core rests with the project merge
...
Patches that change Condominium consensus rules are considerably more involved than
...
Where a patch set proposes to change the Condominium consensus, it must have been
...
The project leader is the release manager for each Condominium Core release.
